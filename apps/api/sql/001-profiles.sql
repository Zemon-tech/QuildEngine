-- ==========================================
-- PHASE 1: AUTHENTICATION SCHEMA & PROVISIONS
-- ==========================================
...
-- Drop existing trigger if it exists to prevent duplicate trigger definition errors
...
-- ==========================================================
-- UTILITY COMMANDS (Run separately in SQL Editor to promote)
-- ==========================================================

-- To promote your first user to admin, run this in Supabase:
--
...
-- UPDATE auth.users 
-- SET raw_app_meta_data = coalesce(raw_app_meta_data, '{}'::jsonb) 
--   || '{"role": "admin", "status": "active"}'::jsonb 
-- WHERE email = 'your_registered_email@example.com';

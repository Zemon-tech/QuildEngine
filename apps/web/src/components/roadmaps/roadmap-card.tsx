    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-sm text-xs border-t border-[var(--card-border)]/50 pt-5 mt-auto">
          <div>
            <p className="text-[10px] uppercase font-semibold tracking-wider text-[var(--sb-ink-dim)]">
              Duration
            </p>
            <p className="mt-1 font-semibold text-[var(--sb-ink)]">
              {category.duration}
            </p>
          </div>
          <div>

  ...
  const categories: CategoryItem[] = [
    {
      ...
      description: "Neural architectures, alignment models, multi-modal cognitive pipelines.",
    ...
    },
    {
      ...
      description: "Statistical learning theory, vector distributions, inference pipelines.",
    ...
    },
    {
      ...
      description: "Distributed compiles, compilation optimization, static analysis engines.",
      icon: <Code2 className="w-8 h-8 text-emerald-500 dark:text-emerald-400" />,
      gradient: "from-emerald-500/10 via-teal-500/5 to-transparent",
      glow: "group-hover:shadow-[0_0_30px_rgba(16,185,129,0.1)]",
    },
    {
      name: "Robotics & Mechanics",
      description: "Control optimization, spatial coordinates, physics simulation modeling.",
    ...
    },
    {
      ...
      description: "Cryptography models, secure enclave isolation, zero-knowledge verification.",
      icon: <ShieldAlert className="w-8 h-8 text-rose-500 dark:text-rose-400" />,
      gradient: "from-rose-500/10 via-red-500/5 to-transparent",
      glow: "group-hover:shadow-[0_0_30px_rgba(244,63,94,0.1)]",
    },
    {
      name: "Cloud Computing",
      description: "Edge network architectures, cluster scheduling, global caching consensus.",
      icon: <CloudLightning className="w-8 h-8 text-amber-500 dark:text-amber-400" />,
      gradient: "from-amber-500/10 via-yellow-500/5 to-transparent",
      glow: "group-hover:shadow-[0_0_30px_rgba(245,158,11,0.1)]",
    },
    {
      name: "Bio & Healthcare",
      description: "Protein structures, genomic databases, diagnostic computer vision.",
    ...
    {
      name: "Education Tech",
      description: "Curriculum graphs, cognitive mapping, personalized synthesis tutors.",
    ...
    <section className="relative w-full max-w-7xl mx-auto px-6 py-12 md:py-16">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-[var(--sb-ink-muted)] text-sm md:text-base">
          Explore specialized libraries mapped to engineering and science disciplines.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((cat, idx) => (
          ...
          >
            {/* Gradient Background */}
            <div className={`absolute inset-0 bg-gradient-to-br ${cat.gradient} opacity-20 dark:opacity-40 group-hover:opacity-60 dark:group-hover:opacity-100 transition-opacity duration-500`} />

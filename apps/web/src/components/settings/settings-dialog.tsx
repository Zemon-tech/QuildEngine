        ...
        try {
          ...
          setProfile({
            header: {
              ...
              username:
                parsed.header?.username ||
                parsed.header?.github?.split("/").pop() ||
                DEFAULT_PROFILE.header.username,
              role: parsed.header?.role || DEFAULT_PROFILE.header.role,
            },
            settings: {
              profilePublic:
                parsed.settings?.profilePublic ??
                DEFAULT_PROFILE.settings.profilePublic,
              showActivity:
                parsed.settings?.showActivity ??
                DEFAULT_PROFILE.settings.showActivity,
              emailNotifications:
                parsed.settings?.emailNotifications ??
                DEFAULT_PROFILE.settings.emailNotifications,
              pushNotifications:
                parsed.settings?.pushNotifications ??
                DEFAULT_PROFILE.settings.pushNotifications,
            },
          });
        } catch (e) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogDescription className="sr-only">
          Manage your Quild workspace settings, account details, and
          ...
          <div className="p-8 max-w-2xl w-full flex flex-col gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--sb-ink-muted)] mt-1">
                ...
                {activeTab === "organisation" &&
                  "Manage organization name, domain, and branding properties."}
                {activeTab === "preferences" &&
                  "Manage privacy options and workflow preferences."}
                {activeTab === "personalization" &&
                  "Customize your app theme and user experience."}
                {activeTab === "assistant" &&
                  "Configure model selections and AI assistant preferences."}
                {activeTab === "shortcuts" &&
                  "Quick guide to keyboard navigation shortcuts."}
                {activeTab === "tasks" &&
                  "Monitor active learning tasks and certification tracks."}
                {activeTab === "notifications" &&
                  "Select how and when you receive email digests or push notifications."}
                {activeTab === "connectors" &&
                  "Manage external integrations like Google and GitHub."}
                {activeTab === "sessions" &&
                  "Monitor active browser sessions and device history."}
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-5 text-xs">
                  ...
                  <div className="flex justify-between items-center py-1">
                    <div>
                      <h4 className="font-semibold text-[var(--page-ink)]">
                        Full Name
                      </h4>
                  ...
                  <div className="flex justify-between items-center py-1">
                    ...
                    <Button
                      ...
                      className="text-xs font-medium cursor-pointer"
                      onClick={() =>
                        startEditing("username", profile.header.username)
                      }
                    >
                      Change username
                    </Button>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div>
                      <h4 className="font-semibold text-xs text-[var(--page-ink)]">
                        Password
                      </h4>
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
            ...
            {activeTab === "preferences" && (
              <div className="space-y-6 text-xs">
                <div className="space-y-4">
                  <h3 className="font-semibold text-xs uppercase tracking-wider text-[var(--sb-ink-muted)]">
                    Privacy & Profile
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                        Show solved problem stats and streaks on your header
                        card.
                      </p>
                    </div>
                    <Switch
            ...
            {activeTab === "personalization" && (
              <div className="space-y-6 text-xs">
                <div className="space-y-4">
                  ...
                  <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                    Select your preferred app appearance style.
                  </p>
                  ...
                  <div className="grid grid-cols-3 gap-3 pt-2">
                    <button
                      ...
                      className={cn(
                        ...
                        theme === "light"
                          ? "border-[var(--sb-accent)] bg-[var(--sb-pill)] font-semibold"
                          : "border-[var(--sb-border)] hover:bg-[var(--sb-bg-hover)]",
                      )}
                    >
              ...
              <div className="space-y-6 text-xs">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-medium text-[var(--page-ink)]">
                      Model Selection
                    </label>
                    <select
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    ...
                    />
                    <p className="text-[10px] text-[var(--sb-ink-muted)]">
                      Controls random generation weights: higher means more
                      creative/random replies.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "shortcuts" && (
              <div className="space-y-6 text-xs">
                <div className="space-y-3">
                  ...
                  >
                    <div
                      className="grid grid-cols-2 p-3 font-semibold border-b text-[var(--page-ink)]"
                      style={{ borderColor: "var(--sb-border)" }}
                    >
                      <span>Action</span>
                      <span>Shortcut</span>
                    ...
                    <div
                      className="divide-y text-[var(--sb-ink-muted)]"
                      style={{ borderColor: "var(--sb-border)" }}
                    >
                  ...
                  <div className="space-y-2.5">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                          Solve 12 Graph challenges before next assessment.
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                          Watch mock webinar recordings on microservices.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                        Weekly digests on certifications, DSA tests, and news.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                        Get immediate browser banner updates on AI reports.
                      </p>
                    </div>
                    <Switch
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                            Connected as {profile.header.email}
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                            Connect to sync repositories and build cards
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-[var(--page-ink)] flex items-center gap-2">
                          ...
                          <span className="text-[10px] px-1.5 py-0.5 bg-emerald-500/10 text-emerald-600 rounded-full font-semibold">
                            Active now
                          </span>
                        </h4>
                        <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                          IP: 192.168.1.18 · San Francisco, CA
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-[var(--sb-ink-dim)] mt-0.5">
                          Last active: 2 hours ago · California, USA
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div>
                      ...
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                        Enjoy unlimited AI code reviews and course access.
                      </p>
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-[11px] text-[var(--sb-ink-muted)] mt-0.5">
                        View your receipts and invoice download links.
                      </p>
                    </div>

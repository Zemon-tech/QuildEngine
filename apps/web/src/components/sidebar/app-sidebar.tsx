      ...
      >
        ...
        <ScrollArea className="flex-1 overflow-hidden">
          <nav className="flex flex-col gap-1 py-2">
            {/* ── Dashboard ──────────────────────────────── */}
            <NavSection label="Dashboard" collapsed={collapsed}>
              <NavItem
            ...
            {/* ── Courses ────────────────────────────────── */}
            <NavSection label="Courses" collapsed={collapsed} showSeparatorAbove>
              <NavItem
                icon={BookOpen}
                label="All Courses"
                to="/courses"
            ...
            {/* ── Learn ──────────────────────────────────── */}
            <NavSection label="Learn" collapsed={collapsed} showSeparatorAbove>
              <NavItem
                icon={ScrollText}
                label="Tutorials"
                to="/learn/tutorials"
            ...
            {/* ── Practice ───────────────────────────────── */}
            <NavSection label="Practice" collapsed={collapsed} showSeparatorAbove>
              <NavAccordion
                icon={Code2}
                label="DSA"
                collapsed={collapsed}
            ...
            {/* ── Events ─────────────────────────────────── */}
            <NavSection label="Events" collapsed={collapsed} showSeparatorAbove>
              <NavItem
                icon={Calendar}
            ...
            {/* ── Knowledge ──────────────────────────────── */}
            <NavSection label="Knowledge" collapsed={collapsed} showSeparatorAbove>
              <NavItem
                icon={BookMarked}
                label="Documentation"
                to="/documentation"
            ...
            {/* ── Profile ────────────────────────────────── */}
            <NavSection label="Profile" collapsed={collapsed} showSeparatorAbove>
              <NavItem
                icon={Trophy}
                label="Achievements"

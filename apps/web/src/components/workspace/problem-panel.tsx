...
export function ProblemPanel({ problemId }: ProblemPanelProps) {
  const search = useSearch({ from: "/_app/practice/problem/$problemId" });
  const activeTab = (search.tab as string) || "description";
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 bg-[#0A0A0A] scrollbar-thin">
          {problem ? (
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                {problem.tags.map((tag) => (
                  <span key={tag} className="text-xs text-[#A3A3A3]">
                    {tag}
                  </span>
                ))}
              </div>
                  ...
                  <div key={idx} className="space-y-3">
                    ...
                    <div className="bg-[#111111] rounded-lg p-4 font-mono text-xs border border-[#262626] space-y-1 select-text">
                      <div className="text-[#A3A3A3]">
                        Input:{" "}
                        <span className="text-[#FAFAFA]">{ex.input}</span>
                      </div>
                      <div className="text-[#A3A3A3]">
                        Output:{" "}
                        <span className="text-[#FAFAFA]">{ex.output}</span>
                      </div>
                      {ex.explanation && (
                        <div className="text-[#A3A3A3] mt-2">
                          Explanation:{" "}
                          <span className="text-[#E5E5E5] block mt-1 font-sans">
                            {ex.explanation}
                          </span>
                        </div>
                      )}
            ...
            >
              ...
              <p className="text-sm text-[#FAFAFA] leading-relaxed">
                Given a <strong>sorted</strong> integer array <code>arr</code>,
                two integers <code>k</code> and <code>x</code>, return the{" "}
                <code>k</code> closest integers to <code>x</code> in the array.
                The result should also be sorted in ascending order.
              </p>

              <p className="text-sm text-[#A3A3A3] leading-relaxed">
                An integer <code>a</code> is closer to <code>x</code> than an
                integer <code>b</code> if:
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-[#111111] rounded-lg p-4 font-mono text-xs border border-[#262626] space-y-1">
                  ...
                  <div className="text-[#A3A3A3]">
                    Output: <span className="text-[#FAFAFA]">[1,2,3,4]</span>
                  </div>
                </div>
              </div>
            ...
            {problem && problem.hints && problem.hints.length > 0 ? (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {problem.hints.map((hint, idx) => (
                    <div
                      key={idx}
                      className="bg-[#111111] border border-[#262626] rounded-lg p-4 text-xs text-[#E5E5E5] space-y-1 select-text"
                    >
                      <span className="font-semibold text-[#FAFAFA]">
                        Hint {idx + 1}
                      </span>
                      <p className="text-[#A3A3A3] mt-1 leading-relaxed">
                        {hint}
                      </p>
                    </div>
                  ))}
              ...
              <div className="text-[#A3A3A3] flex flex-col items-center justify-center py-20 text-center space-y-3">
                ...
                <p className="text-xs max-w-sm">
                  Detailed solution approaches, optimized space/time
                  complexities, and walk-throughs will be rendered here.
                </p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="ai" className="mt-0 outline-none">
            <div className="text-[#A3A3A3] flex flex-col items-center justify-center py-20 text-center space-y-3">
              ...
              <p className="text-xs max-w-sm">
                Ask questions, get help refactoring, or generate hints about the
                problem instantly.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="discussion" className="mt-0 outline-none">
            <div className="text-[#A3A3A3] flex flex-col items-center justify-center py-20 text-center space-y-3">
              ...
              <p className="text-xs max-w-sm">
                See discussion posts, questions, and alternate solutions shared
                by other users.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="submissions" className="mt-0 outline-none">
            <div className="text-[#A3A3A3] flex flex-col items-center justify-center py-20 text-center space-y-3">
              ...
              <p className="text-xs max-w-sm">
                Your past submission results, execution speeds, and memory
                usages will appear here.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="review" className="mt-0 outline-none">
            <div className="text-[#A3A3A3] flex flex-col items-center justify-center py-20 text-center space-y-3">
              ...
              <p className="text-xs max-w-sm">
                Add this problem to your spaced repetition queue to solve it
                again later.
              </p>
            </div>
          </TabsContent>

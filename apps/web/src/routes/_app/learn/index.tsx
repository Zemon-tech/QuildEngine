...
import { FileText, Map, ScrollText, StickyNote } from "lucide-react";
...
const sections = [
  {
    ...
    label: "Tutorials",
    count: 142,
    desc: "Step-by-step coding tutorials",
  },
  {
    icon: FileText,
    label: "Articles",
    count: 380,
    desc: "In-depth technical articles",
  },
  {
    icon: Map,
    label: "Roadmaps",
  ...
  },
  {
    ...
    label: "Notes",
    count: 0,
    desc: "Your personal learning notes",
  },
];

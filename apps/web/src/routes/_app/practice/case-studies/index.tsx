...
import { BarChart3, Briefcase, Server, Trophy } from "lucide-react";
import { useCaseStudiesCategories } from "#/hooks/use-practice";

export const Route = createFileRoute("/_app/practice/case-studies/")({
  component: CaseStudiesLandingPage,
});
...
const colorGradients: Record<string, string> = {
  product: "from-blue-500/10 to-cyan-500/10 border-blue-500/20 text-blue-500",
  "system-design":
...
function CaseStudiesLandingPage() {
  const { data: categories = [], isLoading } = useCaseStudiesCategories();
    ...
    <div className="w-full flex-1 min-w-0 px-4 md:px-6 lg:px-8 py-2 space-y-8">
      ...
      >
        <div>
          ...
          >
            Deep-dive into real-world architectures, business decisions, and
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <Briefcase size={18} className="text-[var(--sb-accent)]" />
                ...
                >
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-end justify-between text-xs">
                      <span style={{ color: "var(--sb-ink-muted)" }}>
                        {cat.completedQuestions} / {cat.totalQuestions} studies
                        completed
                      </span>

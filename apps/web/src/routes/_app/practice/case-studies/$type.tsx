...
import { useCaseStudiesCategory } from "#/hooks/use-practice";

export const Route = createFileRoute("/_app/practice/case-studies/$type")({
  component: CaseStudiesTypePage,
});
...
function CaseStudiesTypePage() {
  const { type } = Route.useParams();
  const { data: category, isLoading, error } = useCaseStudiesCategory(type);
    ...
    return (
      <div className="flex h-64 flex-col items-center justify-center gap-3">
        ...
        <p className="text-sm font-semibold" style={{ color: "var(--sb-ink)" }}>
          Case Study category not found or failed to load.
        </p>
        <Link
  ...
  return (
    <div className="w-full flex-1 min-w-0 px-4 md:px-6 lg:px-8 py-2 space-y-6">
      {/* Back button */}
      <div>
        <Link
          to="/practice/case-studies"
      ...
      >
        ...
        >
          ...
          <div className="text-[10px]" style={{ color: "var(--sb-ink-dim)" }}>
            {category.completedQuestions} / {category.totalQuestions} studies
            cleared
          </div>
        </div>
      </div>
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div
                      ...
                      style={{ color: "var(--sb-ink-muted)" }}
                    >
                      <span>{sub.questionCount} Case Problems</span>

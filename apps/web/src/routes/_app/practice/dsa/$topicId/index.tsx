...
function PracticeBoardTab() {
  ...
  // selectedProblem reserved for future workspace drawer — currently managed inside ProblemTable
  const [_selectedProblem, setSelectedProblem] = useState<DSAProblem | null>(null);

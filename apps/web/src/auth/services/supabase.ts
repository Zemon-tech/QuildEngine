...
/**
 * Lazy/safe initialization helper for client-side Supabase.
 * Uses only publishable keys; safe for browser environments.
 */
export function getSupabase() {
  ...
  if (!url || !key) {
    // Return a safe placeholder client during static generation/builds
